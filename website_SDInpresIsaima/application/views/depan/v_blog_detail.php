    ...
    <header style="padding: 30px 0;">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="brand">
                        <img src="<?php echo base_url() . 'assets/img/logo-toga.png' ?>" alt="" style="margin-right: 20px;">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="blog-tiltle_block">
                        ...
                        <div class="blog-icons" style="margin-top: -30px;">
                        </div>
                        <!-- Nav tabs -->
                                    ...
                                    <form action="<?php echo site_url('blog/komentar'); ?>" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <button type="submit" class="btn btn-warning btn-blogsearch" />Kirim Komentar</button>
                                            </div>
                                            <!-- // end .col-12 -->
                                        </div>
                                    </form>
