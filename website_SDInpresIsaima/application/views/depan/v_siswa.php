                ...
                <div class="col-md-8">
                    <div class="brand" style="display: flex;">
                        ...
                        <div class="brand-name">
                            <h1 style="font-size: 40px; color: #15477A; text-transform: uppercase; font-family: Raleway, 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">SEKOLAH DASAR INPRES ISAIMA</h1>
