...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?php echo base_url() . 'admin/tulisan/add_tulisan' ?>"><i class="fa fa-thumb-tack"></i> Post Arikel</a></li>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2021 <b>Sd Ipress Isaima</b>.</strong> All rights reserved.
    </footer>
